    ...
    return (
      ...
      >
        ...
        {index !== experience.length - 1 && (
          <div className="absolute left-8 top-20 w-0.5 h-full bg-gradient-to-b from-blue-500/50 to-purple-500/50 hidden lg:block" />
        )}
        
        {/* Timeline Dot */}
        <div className="absolute left-6 top-8 w-4 h-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full border-4 border-white dark:border-gray-900 hidden lg:block" />
        ...
        >
          <div className="bg-white/5 dark:bg-gray-800/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10 dark:border-gray-700/10">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-6">
              Currently seeking full-time software development roles where I can contribute 
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
            >
              Let's Connect
            </motion.a>
          </div>
